...
Em.I18n.translations = {
  ...
  'app.aboutAmbari.licensed': '基于Ambari 2.2.2版本',
  ...
  'graphs.noData.message': '没有可获取的数据',
  'graphs.noData.tooltip.title': '没有可获取的数据. Ambari Metrics service 未被安装或无法访问',
  'graphs.noDataAtTime.message': '当前没有可获取的数据',
  'graphs.error.title': '错误',
  'graphs.error.message': '获取图表信息出现错误 ({0}: {1})',
  'graphs.timeRange.hour': '最近 1 小时',
  'graphs.timeRange.twoHours': '最近 2 最近',
  'graphs.timeRange.fourHours': '最近 4 最近',
  'graphs.timeRange.twelveHours': '最近 12 最近',
  'graphs.timeRange.day': '最近 24 最近',
  ...
  'alerts.table.header.lastTrigger': '上次变动',
  ...
  'services.service.summary.nameNodeUptime':'NameNode 运行时长',
  ...
  'services.service.summary.blocksTotal':'Blocks (总数)',
  ...
  'services.service.summary.jobTrackerUptime':'JobTracker 运行时长',
  ...
  'services.service.summary.masterStarted':'Master 启动时长',
  'services.service.summary.masterActivated':'Master 激活时长',
  ...
  'services.service.actions.run.rebalanceHdfsNodes':'平衡 HDFS',
  ...
  'services.service.actions.run.yarnRefreshQueues.menu':'刷新 YARN',
  'services.service.actions.run.yarnRefreshQueues.context':'刷新 YARN',
  ...
  'services.service.info.metrics.yarn.allocated.memory': 'Cluster 内存',
  ...
  'hosts.decommission.popup.body':'确认么?',
  ...
  'hosts.passiveMode.popup':'确认将 {1} 的<b>安全模式设为 {0} </b> ?',
  ...
  'charts.heatmap.selectMetric':'选择热点',
  ...
  'dashboard.clusterMetrics.load':'Cluster 负载',
  ...
  'dashboard.widgets.NameNodeCpu': 'NameNode CPU 读写',
  ...
  'dashboard.widgets.nothing': '没有可增加的监控',
  'dashboard.widgets.NameNodeUptime': 'NameNode 运行时长',
  ...
  'dashboard.widgets.HBaseAverageLoad': 'HBase Ave 负载',
  'dashboard.widgets.HBaseMasterHeap': 'HBase Master 堆',
  'dashboard.widgets.HBaseRegionsInTransition': 'Region In Transition',
  'dashboard.widgets.HBaseMasterUptime': 'HBase Master 运行时长',
  'dashboard.widgets.ResourceManagerHeap': 'ResourceManager 堆',
  'dashboard.widgets.ResourceManagerUptime': 'ResourceManager 运行时长',
  'dashboard.widgets.NodeManagersLive': 'NodeManagers 存活率',
  ...
  'dashboard.widgets.HawqSegmentUp': 'HAWQ Segments 存活率',
  ...
  'dashboard.services.hdfs.blockErrors':'{0} 损坏 / {1} 丢失 / {2} 待复制',
  ...
  'dashboard.services.yarn.nodeManagers.status.msg': '{0} 激活 / {1} 丢失 / {2} 异常 / {3} 重启 / {4} 停止使用',
  ...
  'dashboard.configHistory.title': '配置记录',
  ...
  'restart.service.all.affected': '重启变化的',
